...
const Footer = () => {
  return (
    <footer className="bg-black pb-[112px] desktop:pb-[94px]">
      <div className="container flex flex-col items-center justify-center desktop:items-start relative">
        <h1 className="uppercase leading-none font-bold text-[48px] tablet:text-[64px] desktop:text-[102px] max-w-[238px] tablet:max-w-[500px] desktop:max-w-[1000px] mt-[112px] desktop:mt-[21px]">
